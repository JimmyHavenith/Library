...
<body>
	...
	<div id="content">
		<div id="fiche">
			...
			<p>
				<img src="./img/libraries/<?= $libraries->img_file ?>">
			</p>
			<p class="biographie">
				<?= $libraries->biography ?>
			</p>
		...
		<?php if( isset($_SESSION['connected'] ) && $_SESSION['isAdmin'] == '1' ): ?>
			<form class="formulaire" method="post" action="index.php?a=delete&e=libraries" enctype="multipart/form-data">
				<div>
					<input type="hidden" name="id" value="<?= $libraries->id ?>">
					<input type="submit" id="supprimerLibrary" value="supprimer">
				</div>	
			</form>
		<?php endif; ?>
	</div>
