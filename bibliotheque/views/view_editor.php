...
<body>
	...
	<div id="content">
		<div id="fiche">
			<h1><?= $editors->name; ?></h1>	
			<p>
				<img src="./img/editors/<?= $editors->img_file ?>">
			</p>
			<p class="biographie">
				<?= $editors->biography ?>
			</p>
		...
		<?php if( isset($_SESSION['connected'] ) && $_SESSION['isAdmin'] == '1' ): ?>
			<form class="formulaire" method="post" action="index.php?a=delete&e=editors" enctype="multipart/form-data">
					<div>
						<input type="hidden" name="id" value="<?= $editors->id ?>">
						<input type="submit" id="supprimerEditor" value="supprimer">
					</div>	
			</form>
		<?php endif; ?>
	</div>
